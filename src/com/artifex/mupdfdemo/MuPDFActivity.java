...
import com.artifex.mupdfdemo.ListSearchAsync.ListSearchListener;
...
public class MuPDFActivity extends Activity implements ListSearchListener
{
...
//				
//				//return super.onDoubleTap(arg0);
//				return true;
//			}
			
		};
		mDocView.setMuPDFCore(core);
...
//		});
		...
		mLinkButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				mDocView.setLinkHighlitingEnabled(mLinkHighlight);
			}
		});
...
//	// To return ArrayList of all textual pages in complete pdf
//	private ArrayList<SearchData> createArrayListOfTextualPages()
//	{
//		ArrayList<SearchData> searchListing = null;
//		String searchString = mSearchText.getText().toString();
//		for (int i = 0; i < core.countPages(); i++) 
//		{
//			byte[] bytes = core.html(i);
...
//				String lowerCaseSpanText = htmlText.toLowerCase();
//				String lowerCaseSearchString = searchString.toLowerCase();
//				int startIndex = 0;
//				int searchFoundIndex = -1;
//				while((searchFoundIndex = lowerCaseSpanText.indexOf(lowerCaseSearchString, startIndex)) != -1)
//				{
//					String subStringContainingSearchString = getSubStringContainingSearchString(htmlText.substring(startIndex), lowerCaseSearchString);
//					
//					if(searchListing == null)
//						searchListing = new ArrayList<SearchData>();
//					SearchData searchData = new SearchData();
//					searchData.pageNumber = i;
//					searchData.spanText = subStringContainingSearchString;//spanText.substring(start, end);
...
//		mSearchTask.go(mSearchText.getText().toString(), direction, displayPage, searchPage);
		...
		String searchString = mSearchText.getText().toString();
		new ListSearchAsync(this, core).execute(searchString);
	...
	public void onSearchCompleted(ArrayList<SearchData> searchList) {
		...
		intent.putExtra("pdf_url", filePath);
		PDFSearchResultManager.getSharedInstance().setSearchResult(searchList);
