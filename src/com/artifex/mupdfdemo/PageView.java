		...
		if (mSearchView == null) {
			mSearchView = new View(mContext) {
				...
				protected void onDraw(final Canvas canvas) {
					...
					//pgogna This is to draw rect on the double tapped textual area
					if (rect != null) {
//						mSearchView.setBackgroundColor(HIGHLIGHT_COLOR);
						paint.setColor(HIGHLIGHT_COLOR);
						Log.v("","scale: " + scale + " " + mSourceScale + " " + getWidth() + " " + mSize.x);
