...
public class MuPDFCore
{
	...
	private native RectF getBoundingBoxInternal(float x, float y, int screenWidth, int screenHeight);
	...
	public synchronized RectF getBoundingBox(float x, float y, int screenWidth, int screenHeight, int pageNumber)
	{
		gotoPage(pageNumber);
		RectF rect = getBoundingBoxInternal(x, y, screenWidth, screenHeight);
		return rect;
	}
}
