...
public class MuPDFReaderView extends ReaderView {
	...
	private boolean mLinkHighlightsEnabled = false;
	...
	public void setLinkHighlitingEnabled(boolean b)
	{
		mLinkHighlightsEnabled = b;
	}
...
//				super.smartMoveForwards();
	...
	protected void onChildSetup(int i, View v) {
		...
		((MuPDFView) v).setLinkHighlighting(mLinkHighlightsEnabled);
	...
	protected RectF getContainingBoundingBox(float x, float y, int screenWidth, int screenHeight) {
		...
		return core.getBoundingBox(x, y, screenWidth, screenHeight, getDisplayedViewIndex());
	}
	...
	public void setMuPDFCore(MuPDFCore core) {
		this.core = core;
	}
}
